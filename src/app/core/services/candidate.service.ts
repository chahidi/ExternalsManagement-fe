...
export class CandidateService {
  ...
  updateCandidate(id: string, candidate: Candidate): Observable<Candidate> {
    ...
    console.log('data sent to backend:', cleanedCandidate);
  ...
  // Supprimer un candidat (version 1)
  ...
  // Supprimer un candidat (version alternative retournant string)
  deleteCandidateWithTextResponse(id: string): Observable<string> {
